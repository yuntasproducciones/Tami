        ...
        <div className="bg-gradient-to-b from-[#015e81] to-[#011821] py-12 md:py-16 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute top-0 left-0 w-20 md:w-1/6 lg:w-1/5 h-full bg-gradient-to-r from-[#015e81] to-transparent z-10 pointer-events-none" aria-hidden="true"/>
                    <div className="absolute top-0 right-0 w-20 md:w-1/6 lg:w-1/5 h-full bg-gradient-to-l from-[#015e81] to-transparent z-10 pointer-events-none" aria-hidden="true" />
